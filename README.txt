...
a persistence unit "pruebaramirezjPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaramirezj/pom.xml":
...
artifact ("pruebaramirezj.war") is already built. You can build
